...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imgViewToDoList = (ImageView)rowView.findViewById(R.id.imageViewSign);
        ...
        if(currentItem.isImportant()==true){
           imgViewToDoList.setImageResource(R.drawable.impt);
        }
        else{
            imgViewToDoList.setImageResource(R.drawable.todo);
        }
